      ...
      <form action="cadastra-cliente.php" method="post">
        ...
        <div class="top-row">
          ...
          <div class="field-wrap">
            ...
            <input id="cpf" type="text" placeholder="CPF" required autocomplete="off" name="cpfCliente" />
          </div>
        </div>

        <div class="field-wrap">
          <h3>Contato(Telefone)</h3>
          <input onkeydown="return mascaraTelefone(event)" type="text" placeholder=" numero(telefone)" required autocomplete="off" name="celularCliente" />
        </div>
        ...
        <table class="table">
          ...
          <?php foreach ($listaCliente as $linha)
            ...
            <tr>
              ...
              <td>" . $linha['celularcliente'] . "</td>
              <td>" . $linha['cpfcliente'] . "</td>
              <td><a class='button-card' href='excluir.php?excluirCliente=" . $linha['idcliente'] . "'>Excluir</td>
            </tr>
            ");
          ?>
        </table>
