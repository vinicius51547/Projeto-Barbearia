  ...
  <div class="form">
    <div class="tab-content">
      ...
      <form action="cadastrar-agenda.php" method="post">
        ...
        <div class="field-wrap">
          <h3>Hora do Corte</h3>
          <input name="horaAgenda" id="horaAgenda" type="time" required />
        </div>
        ...
        <table class="table">
          ...
          <?php foreach ($listaagenda as $linha)
            ...
            <tr>
              ...
              <td>" . $linha['descservico'] . "</td>
              <td>" . $linha['dataagenda'] . "</td>
              <td>" . $linha['horaagenda'] . "</td>
              <td><a class='button-card' href='excluir.php?excluirAgenda=" . $linha['idagenda'] . "'>Excluir</td>
            </tr>
            ");
          ?>
        </table>
