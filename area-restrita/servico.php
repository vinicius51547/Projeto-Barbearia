              ...
              <div class='row'>
                <div class='col-sm-12 wow fadeInDown' data-wow-duration='1000ms' data-wow-delay='500ms'>
                  <div class='service-icon'>
                    <img src=" . $linha['fotoservico'] . " class='img-responsive'>
                    <span class='folio-expand'><a href=" . $linha['fotoservico'] . " data-lightbox='portfolio'><i class='fa fa-search-plus'></i></a></span>
                  </div>
                  <div class='service-info'>
                    <h3>" . $linha['descservico'] . "</h3>
                    <p> " . $linha['textoservico'] . "</p>
                    <td><a class='button-card' href='excluir.php?excluirServico=" . $linha['idservico'] . "'>Excluir</a></td>
                  </div>
                </div>
              </div>
            </div>
